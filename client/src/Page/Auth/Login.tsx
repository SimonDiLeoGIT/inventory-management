    ...
    <div className="min-h-screen bg-zinc-100 dark:bg-zinc-950 flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-white dark:bg-zinc-800/40 border border-zinc-200 dark:border-zinc-400 p-10 rounded-lg">
        ...
        <div className="flex justify-between mt-6">
          <Link to="/login" className="text-xs text-zinc-400 hover:text-zinc-700 transition-colors">
        ...
        <div className="mt-8 pt-6 border-t border-zinc-100">
          <p className="text-xs text-zinc-300 uppercase tracking-widest mb-2">Demo</p>
          <div className="space-y-0.5 font-mono text-xs text-zinc-400">
            <p>admin@inventario.com</p>
            <p>deposito@inventario.com</p>
            <p className="text-zinc-300">(cualquier contraseña)</p>
          </div>
        </div>
